...
class SyncVectorClockCreationTest extends TestCase
{
    #[TestWith([' '])]
    #[TestWith(['a'])]
    #[TestWith(['A'])]
    ...
    public function testWithoutInitialContext(string $node): void
    {
        ...
        self::assertEquals($node, $clock->getNode());
        ...
        self::assertEquals(0, $timestamps[$node]->getValue());
    }
    ...
    public function testInitialContext(string $node, array $initialContext, int $nbExpectedNodes, array $expectedTimestampsValue): void
    {
        ...
        foreach (array_keys($initialContext) as $initialContextKey) {
            ...
            self::assertEquals($expectedTimestampsValue[$initialContextKey], $timestamps[$initialContextKey]->getValue());
        }
    }
